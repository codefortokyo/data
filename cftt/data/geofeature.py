...
class GeoFeature(base.BaseAttribute, base.BaseProperty):
...
class GeoFeatureCollection(collections.MutableSequence, base.BaseAttribute):
    def __init__(self, *args):
        super(GeoFeatureCollection, self).__init__()
        self._features = []
        self.load(*args)
